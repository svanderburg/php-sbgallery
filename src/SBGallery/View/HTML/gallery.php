...
function displayGalleryThumbnail(Gallery $gallery, array $thumbnail, $viewType)
{
	$displayAlbumLinkFunction = '\SBGallery\View\HTML\gallery_display'.$viewType.'AlbumLink';
	?>
	<a href="<?php print($displayAlbumLinkFunction($gallery, $thumbnail["ALBUM_ID"])); ?>">
	<?php
...
function gallery_displayConventionalAlbumLink(Gallery $gallery, $albumId, $operation = null)
{
	if($operation === null)
		$operationParam = "";
	else
...
function gallery_displayLayoutAlbumLink(Gallery $gallery, $albumId, $operation = null)
{
	if($operation === null)
		$operationParam = "";
	else
...
function displayGallery(Gallery $gallery, $viewType = "Conventional")
{
	...
	{
		?>
		<div class="galleryitem"><?php displayGalleryThumbnail($gallery, $row, $viewType); ?></div>
		<?php
	}
...
function displayEditableGallery(Gallery $gallery, $viewType = "Conventional")
{
	$displayAlbumLinkFunction = '\SBGallery\View\HTML\gallery_display'.$viewType.'AlbumLink';
	...
	while(($row = $stmt->fetch()) !== false)
	{
		?>
		<div class="galleryitem">
			<?php displayGalleryThumbnail($gallery, $row, $viewType); ?>
			<br>
			<a href="<?php print($displayAlbumLinkFunction($gallery, $row["ALBUM_ID"], "moveleft_album")); ?>"><img src="<?php print($gallery->iconsPath); ?>/moveleft.png" alt="<?php print($gallery->galleryLabels["Move left"]); ?>"></a>
			<a href="<?php print($displayAlbumLinkFunction($gallery, $row["ALBUM_ID"], "moveright_album")); ?>"><img src="<?php print($gallery->iconsPath); ?>/moveright.png" alt="<?php print($gallery->galleryLabels["Move right"]); ?>"></a>
			<?php
			...
			while(($count_row = $count_stmt->fetch()) !== false)
			{
				...
				{
					?>
					<a href="<?php print($displayAlbumLinkFunction($gallery, $row["ALBUM_ID"], "remove_album")); ?>"><img src="<?php print($gallery->iconsPath); ?>/delete.png" alt="<?php print($gallery->galleryLabels["Remove"]); ?>"></a>
					<?php
				}
			}
			?>
